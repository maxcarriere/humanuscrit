...
<strong><a href="{{ '/textes/fictions/' | relative_url }}">1er Mouvement</a> : Raconter</strong><br>
Textes : Fictions<br>
...
<p style="text-align: center;">
<strong><a href="{{ '/textes/reflexions/' | relative_url }}">2e Mouvement</a> : Penser</strong><br>
...
<p style="text-align: center;">
<strong><a href="{{ '/textes/reflexivite-conscience/' | relative_url }}">3e Mouvement</a> : Se Représenter</strong><br>
...
<p style="text-align: center;">
<strong><a href="{{ '/textes/contes-poesie-eveil/' | relative_url }}">4e Mouvement</a> : Éveiller</strong><br>
...
<p style="text-align: center;">
<strong><a href="{{ '/textes/temoignages-personnel/' | relative_url }}">5e Mouvement</a> : Être</strong><br>
